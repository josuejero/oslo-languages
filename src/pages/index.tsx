...
// Define features array if it doesn't exist
const features = [
  {
    title: "Norwegian Courses",
    description: "Learn Norwegian from beginner to advanced levels with our expert native teachers.",
    icon: "/images/icons/norwegian.svg"
  },
  {
    title: "English Courses",
    description: "Improve your English skills for professional or personal development.",
    icon: "/images/icons/english.svg"
  },
  {
    title: "Spanish Courses",
    description: "Explore the Spanish language and culture with our immersive courses.",

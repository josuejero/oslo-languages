  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 text-white py-20">
        ...
        {/* Decorative shapes */}
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-white opacity-5 rounded-tr-full"></div>
        <div className="absolute top-0 right-0 w-96 h-96 bg-blue-400 opacity-10 rounded-bl-full"></div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Our Language Courses</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {courses.map((course) => {
              ...
              return (
                <div 
                  key={course.id}
                  className={`group relative rounded-xl p-6 border-2 ${colors.border} ${colors.bg} ${colors.hover} transition-all duration-300 hover:shadow-xl flex flex-col h-full transform hover:-translate-y-1`}
                >
                  ...
                  <div className="flex items-start mb-4">
                    <div className="flex-shrink-0 mr-4">
                      <div className="w-14 h-14 rounded-full bg-white shadow-sm flex items-center justify-center p-3">
                        <OptimizedImage
                          src={course.icon}
                          alt={course.language}
                          width={32}
                    ...
                    <div>
                      <h3 className={`text-xl font-bold mb-1 ${colors.heading}`}>{course.title}</h3>
                  ...
                  <div className="mt-auto">
                    <Link 
                      href="/contact"
                      className={`block w-full py-3 px-4 rounded-lg text-center text-white font-medium transition-colors ${colors.button}`}
                    >
                      Inquire Now
                    </Link>
                  </div>
      ...
      <section className="py-16 bg-blue-50 relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute -left-16 -top-16 w-64 h-64 bg-blue-100 rounded-full opacity-50"></div>
        <div className="absolute -right-16 -bottom-16 w-64 h-64 bg-blue-100 rounded-full opacity-50"></div>
        
        <div className="relative container mx-auto px-4 text-center z-10">
          <div className="bg-white p-8 md:p-12 rounded-2xl shadow-xl max-w-3xl mx-auto border border-blue-100">
            ...
            <Link 
              href="/contact"
              className="inline-block bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-md"
            >
              Contact Us
            </Link>
          </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-8 border border-amber-200 relative overflow-hidden group hover:shadow-lg transition-all">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-4 text-gray-900">Expert Teachers</h3>
            ...
            {/* Feature 2 */}
            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-8 border border-emerald-200 relative overflow-hidden group hover:shadow-lg transition-all">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-4 text-gray-900">Small Class Sizes</h3>
                <p className="text-gray-700">
            ...
            {/* Feature 3 */}
            <div className="bg-gradient-to-br from-violet-50 to-violet-100 rounded-xl p-8 border border-violet-200 relative overflow-hidden group hover:shadow-lg transition-all">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-4 text-gray-900">Flexible Schedule</h3>
                <p className="text-gray-700">

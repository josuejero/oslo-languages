  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-fadeIn delay-200">
              ...
              <div className="absolute -left-6 -top-6 w-24 h-24 bg-blue-100 rounded-full -z-10 animate-float" style={{ animationDelay: "1s" }}></div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-purple-100 rounded-full opacity-30 transform -translate-x-1/2 translate-y-1/2 animate-float" style={{ animationDelay: "2s" }}></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-background-primary p-8 rounded-xl shadow-lg border-t-4 border-blue-600 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-fadeIn delay-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-text-primary">Communicative Approach</h3>
            ...
            <div className="bg-background-primary p-8 rounded-xl shadow-lg border-t-4 border-indigo-600 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-fadeIn delay-200">
              ...
              <h3 className="text-xl font-bold mb-4 text-text-primary">Small Group Sizes</h3>
              <p className="text-text-secondary">
            ...
            <div className="bg-background-primary p-8 rounded-xl shadow-lg border-t-4 border-purple-600 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-fadeIn delay-300">
              ...
              <h3 className="text-xl font-bold mb-4 text-text-primary">Cultural Integration</h3>
              <p className="text-text-secondary">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {teachers.map((teacher, index) => (
              ...
              >
                <div className={`bg-background-primary rounded-xl shadow-lg overflow-hidden transition-all duration-500 ${activeTeacher === index ? 'ring-4 ring-purple-400' : ''}`}>
                  ...
                  <div className="p-6">
                    <h3 className="text-2xl font-bold mb-1 text-text-primary">{teacher.name}</h3>

      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mt-12 pt-8 border-t">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Related posts would be dynamically rendered here */}
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-xl font-medium mb-2">
                <Link href="/blog/english-mistakes-norwegian-speakers" className="hover:text-blue-600">
                  Common English Mistakes Made by Norwegian Speakers
                </Link>
              </h3>
              <p className="text-gray-600 mb-2">April 25, 2025</p>
              <p className="text-gray-700">
                Avoid these typical errors that Norwegian native speakers make when learning English.
              </p>
            </div>
          </div>
        </div>
